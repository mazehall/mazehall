(function() {
  ...
  manager = {
    ...
    start: function(port) {
      ...
      this.socket.on("connection", function(socket) {
        ...
        return socket.join(socket.mazehall.component.toLowerCase());
      });
  ...
  manager.method.disconnect = function() {
    console.log("[socket:core] %s disconnect - component: %s", this.handshake.address, this.mazehall.component.toUpperCase());
    this.leave(this.mazehall.component.toLowerCase());
    return this;
  };
